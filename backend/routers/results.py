...
- [실행 항목]
   ...
   HOW: [어떻게 실행할지 - 구체적 방법, 예산, 소요 기간] (절대로 HOW: 뒤에 빈 불릿만 남기지 말 것. 반드시 HOW: 바로 뒤에 내용 작성)
   기한: [언제까지]
...
분량 제한:
- 전체 액션플랜은 반드시 1,500자 이내로 작성할 것
- 단계는 최대 3단계, 각 단계당 액션 항목은 최대 2개
- WHY/HOW는 각각 2문장 이내로 간결하게 작성
- 분량 초과 시 중요도 낮은 항목 삭제하고 반드시 마지막 항목까지 완결할 것
